...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://clearinvest.be/${locale}/analyse-produits/bnp-b-pension`,
    },
  }
}
...
export default async function BnpPensionAnalysisPage() {
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
        ...
        <LastUpdated isoDate="2026-04-09" />
