...
export async function generateMetadata({
  ...
  const titles = { 
    fr: 'BNP Paribas B Pension analyse — Frais de 3% qui détruisent votre retraite', 
    nl: 'BNP Paribas B Pension analyse — 3% instapkosten die uw pensioen vernietigen', 
    en: 'BNP Paribas B Pension Review — How 3% Entry Fees Destroy Your Retirement' 
  }
  const descriptions = { 
    fr: 'BNP Paribas B Pension vaut-il le coup ? Analyse des frais d\'entrée de 3%, du TER de 1,25% et comparaison avec un ETF Monde sur 30 ans.', 
    nl: 'Is BNP Paribas B Pension het waard? Analyse van de instapkosten van 3%, TER van 1,25% en vergelijking met een wereld-ETF over 30 jaar.', 
    en: 'Is BNP Paribas B Pension worth it? Analysis of 3% entry fees, 1.25% TER, and comparison with a World ETF over 30 years.' 
  }
  return {
    title: titles[locale as keyof typeof titles] ?? titles.fr,
    description: descriptions[locale as keyof typeof descriptions] ?? descriptions.fr,
    alternates: buildAlternates(locale, '/analyse-produits/bnp-b-pension'),
  }
}
...
export default async function BnpPensionAnalysisPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  setRequestLocale(locale);

  const t = await getTranslations('analyseBnpPension');

  return (
    <>
      <ArticleJsonLd locale={locale} path="/analyse-produits/bnp-b-pension" namespace="analyseBnpPension" />
      ...
      <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
        ...
        <section>
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-[var(--warm-tan)]/20">
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 font-medium text-red-600">1,25%</td>
                  <td className="px-4 py-3 font-medium text-green-600">0,17%</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 text-[var(--charcoal)]/60">{t('s4_table_row3')}</td>
                  <td className="px-4 py-3 font-medium text-[var(--charcoal)]">{t('s4_val_bnp_return')}</td>
                ...
                <tr className="bg-[var(--warm-white)]/50">
                  ...
                  <td className="px-4 py-3 font-medium text-[var(--charcoal)]">{t('s4_val_bnp_gross')}</td>
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 font-medium text-red-600">{t('s4_val_bnp_exit')}</td>
                ...
                <tr className="border-t-2 border-[var(--warm-tan)]/40 bg-[var(--sage-pale)]/30">
                  ...
                  <td className="px-4 py-4 font-bold text-[var(--charcoal)]">{t('s4_val_bnp_final')}</td>
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 font-bold text-[var(--forest)]">{t('s4_val_bnp_gain')}</td>
          ...
          <PensionFeeChart namespace="analyseBnpPension" grossReturn={0.043} ter={0.0125} />
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-[var(--warm-tan)]/20 tabular-nums">
                <tr>
                  ...
                  <td className="px-4 py-3 font-medium text-green-600">283,50 €</td>
        ...
        <section className="mt-16 rounded-3xl border border-[var(--warm-tan)]/50 bg-[var(--warm-cream)] px-6 py-10 text-center md:px-12 md:py-14">
          <div className="flex flex-col items-center gap-4">
            ...
            <Link
              ...
              className="w-full rounded-xl border border-[var(--forest)]/20 px-8 py-4 text-center text-sm font-bold text-[var(--forest)] transition-colors hover:bg-[var(--sage-pale)]/20 sm:w-auto"
            >
              {t('cta_secondary')}
            </Link>
          </div>
        ...
        <LastUpdated path="/analyse-produits/bnp-b-pension" />
