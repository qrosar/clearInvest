...
export async function generateMetadata({
  ...
  const titles = {
    fr: "AG Safe+ analyse \u2014 213\u00a0000\u00a0\u20ac de manque \u00e0 gagner pour \u00ab\u00a0la s\u00e9curit\u00e9\u00a0\u00bb",
    nl: "AG Safe+ analyse \u2014 213\u00a0000\u00a0\u20ac gemiste winst voor \u00abveiligheid\u00bb",
    en: "AG Safe+ Review \u2014 \u20ac213,000 in Lost Profit for \u2018Safety\u2019"
  }
  const descriptions = {
    fr: "Analyse compl\u00e8te d\u2019AG Safe+ (Branche 21, AG Insurance). Taxe sur prime 2\u00a0%, rendement ~2,80\u00a0%/an. Sur 30 ans, l\u2019\u00e9cart avec un ETF Monde d\u00e9passe 213\u00a0000\u00a0\u20ac m\u00eame apr\u00e8s cr\u00e9dit de l\u2019exon\u00e9ration CGT.",
    nl: "Volledige analyse van AG Safe+ (Tak 21, AG Insurance). Premietaks 2\u00a0%, rendement ~2,80\u00a0%/jaar. Over 30 jaar overstijgt het verschil met een wereld-ETF 213\u00a0000\u00a0\u20ac, zelfs na aftrek van de CGT-vrijstelling.",
    en: "Full review of AG Safe+ (Branch 21, AG Insurance). 2% premium tax, ~2.80%/year return. Over 30 years, the gap with a World ETF exceeds \u20ac213,000 even after full credit for the CGT exemption."
  }
  return {
    title: titles[locale as keyof typeof titles] ?? titles.fr,
    description: descriptions[locale as keyof typeof descriptions] ?? descriptions.fr,
    alternates: buildAlternates(locale, '/analyse-produits/ag-safe-plus'),
  }
}
...
export default async function AgSafePlusAnalysisPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  setRequestLocale(locale);

  const t = await getTranslations('analyseAgSafePlus');

  return (
    <>
      <ArticleJsonLd locale={locale} path="/analyse-produits/ag-safe-plus" namespace="analyseAgSafePlus" />
      ...
      <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
        ...
        <section>
          ...
          <div className="mt-8 rounded-2xl border border-[var(--warm-tan)]/50 bg-[var(--warm-white)] p-6">
            ...
            <InfoRow label={t('s1_label_participation')} value={t('s1_val_participation')} />
        ...
        {/* Section 3: Avantages fiscaux — triés sur le volet */}
        <section>
        ...
        <div className="mt-12 space-y-4">
          ...
          <Link
            href="/analyse-produits/belfius-invest-capital-safe"
            className="flex w-full items-center justify-center rounded-2xl border border-[var(--forest)]/20 bg-white px-8 py-4 text-center font-bold text-[var(--forest)] transition-colors hover:bg-[var(--sage-pale)]/20"
          >
            {t('cta_quaternary')}
          </Link>
        ...
        <LastUpdated path="/analyse-produits/ag-safe-plus" />
