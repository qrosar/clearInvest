...
export async function generateMetadata({
  ...
  const t = await getTranslations('analyseBaloiseInvest');

  return {
    title: t('meta_title'),
    description: t('meta_description'),
    alternates: buildAlternates(locale, '/analyse-produits/baloise-invest'),
  }
}
...
export default async function BaloiseInvestAnalysisPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  ...
  return (
    <>
      <ArticleJsonLd locale={locale} path="/analyse-produits/baloise-invest" namespace="analyseBaloiseInvest" />
      ...
      <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
        ...
        <section>
          ...
          <div className="mt-8 rounded-2xl border border-[var(--warm-tan)]/50 bg-[var(--warm-white)] p-6">
            ...
            <InfoRow label={t('s1_label_total_entry')} value={t('s1_val_total_entry')} />
            ...
            <InfoRow label={t('s1_label_capital_guarantee')} value={t('s1_val_capital_guarantee')} />
        ...
        <section>
          ...
          <NeutralCallout>{t('s3_broker_note')}</NeutralCallout>
        </section>
        ...
        <section>
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-[var(--warm-tan)]/20">
                <tr>
                  ...
                  <td className="px-4 py-3 font-medium text-red-600">{t('s4_table_row1_val1')}</td>
                  <td className="px-4 py-3 font-medium text-green-600">{t('s4_table_row1_val2')}</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 text-[var(--charcoal)]/60">{t('s4_table_row2')}</td>
                  <td className="px-4 py-3 font-medium text-[var(--charcoal)]">{t('s4_table_row2_val1')}</td>
                  <td className="px-4 py-3 font-medium text-[var(--charcoal)]">{t('s4_table_row2_val2')}</td>
                </tr>
                <tr className="bg-[var(--warm-white)]/50">
                  <td className="px-4 py-3 text-[var(--charcoal)]/60">{t('s4_table_row3')}</td>
                  <td className="px-4 py-3 font-medium text-[var(--charcoal)]">{t('s4_table_row3_val1')}</td>
                  <td className="px-4 py-3 font-medium text-[var(--charcoal)]">{t('s4_table_row3_val2')}</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 text-[var(--charcoal)]/60">{t('s4_table_row4')}</td>
                  <td className="px-4 py-3 font-medium text-red-600">{t('s4_table_row4_val1')}</td>
                  <td className="px-4 py-3 font-medium text-red-600">{t('s4_table_row4_val2')}</td>
                </tr>
                <tr className="border-t-2 border-[var(--warm-tan)]/40 bg-[var(--sage-pale)]/30">
                  <td className="px-4 py-4 font-bold text-[var(--charcoal)]">{t('s4_table_row5')}</td>
                  <td className="px-4 py-4 font-bold text-[var(--charcoal)]">{t('s4_table_row5_val1')}</td>
                  <td className="px-4 py-4 font-bold text-[var(--forest)]">{t('s4_table_row5_val2')}</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-bold text-[var(--charcoal)]">{t('s4_table_row6')}</td>
                  <td className="px-4 py-3 font-bold text-[var(--forest)]">{t('s4_table_row6_val1')}</td>
                  <td className="px-4 py-3 font-bold text-[var(--forest)]">{t('s4_table_row6_val2')}</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          {/* Branch 23 comparison table */}
          <p className="mt-10 text-sm leading-relaxed text-[var(--charcoal)]/70">
            {t('s4_b23_intro')}
          </p>
          <div className="mt-4 overflow-hidden rounded-2xl border border-[var(--warm-tan)]/50">
            <table className="w-full text-left text-sm">
              <thead>
                <tr className="bg-[var(--warm-tan)]/10">
                  <th className="px-4 py-3 font-bold text-[var(--charcoal)]">{t('s4_b23_col_product')}</th>
                  <th className="px-4 py-3 font-bold text-[var(--charcoal)]">{t('s4_b23_col_fees')}</th>
                  <th className="px-4 py-3 font-bold text-[var(--charcoal)]">{t('s4_b23_col_gain')}</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[var(--warm-tan)]/20">
                <tr>
                  <td className="px-4 py-3 font-medium text-[var(--charcoal)]">{t('s4_b23_row_nn')}</td>
                  <td className="px-4 py-3 text-[var(--charcoal)]/70">{t('s4_b23_row_nn_fees')}</td>
                  <td className="px-4 py-3 font-medium text-[var(--forest)]">{t('s4_b23_row_nn_gain')}</td>
                </tr>
                <tr className="bg-[var(--warm-white)]/50">
                  <td className="px-4 py-3 font-medium text-[var(--charcoal)]">{t('s4_b23_row_ag')}</td>
                  <td className="px-4 py-3 text-[var(--charcoal)]/70">{t('s4_b23_row_ag_fees')}</td>
                  <td className="px-4 py-3 font-medium text-[var(--forest)]">{t('s4_b23_row_ag_gain')}</td>
                </tr>
                <tr className="border-t-2 border-amber-200 bg-amber-50/40">
                  <td className="px-4 py-3 font-bold text-[var(--charcoal)]">{t('s4_b23_row_bal')}</td>
                  <td className="px-4 py-3 font-medium text-amber-700">{t('s4_b23_row_bal_fees')}</td>
                  <td className="px-4 py-3 font-bold text-red-600">{t('s4_b23_row_bal_gain')}</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p className="mt-3 text-sm leading-relaxed text-[var(--charcoal)]/60">
            {t('s4_b23_callout')}
          </p>

          <NeutralCallout>{t('s4_nuance_note')}</NeutralCallout>
        ...
        <section className="rounded-3xl bg-[var(--forest-deep)] p-8 text-white md:p-12">
          ...
          <div className="mt-6 space-y-4 opacity-90 text-base leading-relaxed">
            ...
            <p>{t('s6_verdict_p3')}</p>
            <p>{t('s6_verdict_p4')}</p>
            <p className="text-sm italic">{t('s6_verdict_p5')}</p>
          </div>
          ...
          <p className="mt-6 text-sm italic opacity-70">{t('s6_exit_note')}</p>
        </section>
        ...
        <div className="mt-12 space-y-4">
          ...
          <Link
            href="/analyse-produits/nn-strategy"
        ...
        <LastUpdated path="/analyse-produits/baloise-invest" />
