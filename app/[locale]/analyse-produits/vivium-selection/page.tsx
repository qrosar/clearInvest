...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: buildAlternates(locale, '/analyse-produits/vivium-selection'),
  }
}
...
export default async function ViviumSelectionPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  ...
  return (
    <>
      <ArticleJsonLd locale={locale} path="/analyse-produits/vivium-selection" namespace="analyseViviumSelection" />
      ...
      <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
        ...
        <LastUpdated path="/analyse-produits/vivium-selection" />
