      ...
      <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
        ...
        <section className="mt-14">
          ...
          <div className="mt-8 rounded-2xl border border-[var(--warm-tan)]/50 bg-[var(--warm-white)] p-6">
            ...
            <InfoRow label={t('s1_label_launch')} value={t('s1_val_launch')} />
            ...
            <InfoRow label={t('s1_label_perf_1y')} value={t('s1_val_perf_1y')} />
            <InfoRow label={t('s1_label_perf_3y')} value={t('s1_val_perf_3y')} />
            <InfoRow label={t('s1_label_perf_5y')} value={t('s1_val_perf_5y')} />
          </div>
        ...
        {/* Section 2: Ce qui distingue AXA Index4P */}
        <section>
          <SectionHeading>{t('s2_title')}</SectionHeading>
          <Body>{t('s2_p1')}</Body>
          <Body>{t('s2_p2')}</Body>
          <Body>{t('s2_p3')}</Body>
          <NeutralCallout>{t('s2_index_note')}</NeutralCallout>
        </section>
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-[var(--warm-tan)]/20">
                <tr className="bg-[var(--sage-pale)]/30">
                  <td className="px-4 py-3 font-bold text-[var(--forest)]">AXA Index4P</td>
                  <td className="px-4 py-3 font-bold text-[var(--forest)]">1,40 %</td>
                  <td className="px-4 py-3 font-medium text-[var(--forest)]">{t('s3_table_passive')}</td>
                </tr>
                <tr>
        ...
        {/* Section 4: L'épargne à long terme */}
        <section>
          <SectionHeading>{t('s4_title')}</SectionHeading>
          <Body>{t('s4_intro')}</Body>
          <Body>{t('s4_lts_p1')}</Body>
          <Body>{t('s4_lts_p2')}</Body>
          <div className="mt-4">
            <Link
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-[var(--warm-tan)]/20">
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 font-medium text-red-600">{t('s4_table_row5_val1')}</td>
                  <td className="px-4 py-3 font-medium text-green-600">{t('s4_table_row5_val2')}</td>
                </tr>
                <tr className="bg-[var(--warm-white)]/50">
                  <td className="px-4 py-3 text-[var(--charcoal)]/60">{t('s4_table_row6')}</td>
                  <td className="px-4 py-3 font-medium text-green-600">{t('s4_table_row6_val1')}</td>
                  <td className="px-4 py-3 font-medium text-red-600">{t('s4_table_row6_val2')}</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 text-[var(--charcoal)]/60">{t('s4_table_row7')}</td>
                  <td className="px-4 py-3 font-medium text-[var(--charcoal)]">{t('s4_table_row7_val1')}</td>
                  <td className="px-4 py-3 font-medium text-[var(--charcoal)]">{t('s4_table_row7_val2')}</td>
                </tr>
                <tr className="bg-[var(--warm-white)]/50">
                  <td className="px-4 py-3 text-[var(--charcoal)]/60">{t('s4_table_row8')}</td>
                  <td className="px-4 py-3 font-medium text-[var(--charcoal)]">{t('s4_table_row8_val1')}</td>
                  <td className="px-4 py-3 font-medium text-red-600">{t('s4_table_row8_val2')}</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 text-[var(--charcoal)]/60">{t('s4_table_row9')}</td>
                  <td className="px-4 py-3 font-medium text-red-600">{t('s4_table_row9_val1')}</td>
                  <td className="px-4 py-3 font-medium text-[var(--charcoal)]/40">{t('s4_table_row9_val2')}</td>
                </tr>
                <tr className="bg-[var(--warm-white)]/50">
                  <td className="px-4 py-3 text-[var(--charcoal)]/60">{t('s4_table_row10')}</td>
                  <td className="px-4 py-3 font-medium text-red-600">{t('s4_table_row10_val1')}</td>
                  <td className="px-4 py-3 font-medium text-[var(--charcoal)]/40">{t('s4_table_row10_val2')}</td>
                </tr>
                <tr className="border-t-2 border-[var(--warm-tan)]/40 bg-[var(--sage-pale)]/30">
                  <td className="px-4 py-4 font-bold text-[var(--charcoal)]">{t('s4_table_row11')}</td>
                  <td className="px-4 py-4 font-bold text-[var(--charcoal)]">{t('s4_table_row11_val1')}</td>
                  <td className="px-4 py-4 font-bold text-[var(--forest)]">{t('s4_table_row11_val2')}</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-bold text-[var(--charcoal)]">{t('s4_table_row12')}</td>
                  <td className="px-4 py-3 font-bold text-[var(--charcoal)]">{t('s4_table_row12_val1')}</td>
                  <td className="px-4 py-3 font-bold text-[var(--forest)]">{t('s4_table_row12_val2')}</td>
                </tr>
              </tbody>
            </table>
          </div>

          <NeutralCallout>{t('s4_conditions_note')}</NeutralCallout>
        ...
        {/* Section 5: Sans épargne à long terme */}
        <section>
