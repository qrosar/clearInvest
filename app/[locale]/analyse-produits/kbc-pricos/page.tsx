...
export async function generateMetadata({
  ...
  const titles = { 
    fr: 'KBC Pricos : analyse complète et comparaison ETF 2026', 
    nl: 'KBC Pricos: volledige analyse en ETF-vergelijking 2026', 
    en: 'KBC Pricos: Full Analysis and ETF Comparison 2026' 
  }
  const descriptions = { 
    fr: 'KBC Pricos vaut-il vraiment le coup ? Analyse des frais réels (TER 1,53%, frais d\'entrée 2%), taxe de sortie à 60 ans, et comparaison avec un ETF Monde sur 30 ans.', 
    nl: 'Is KBC Pricos het waard? Analyse van de echte kosten (TER 1,53%, instapkosten 2%), uitstaptaks op 60 jaar, en vergelijking met een wereld-ETF over 30 jaar.', 
    en: 'Is KBC Pricos worth it? Analysis of real costs (TER 1.53%, 2% entry fee), exit tax at 60, and comparison with a World ETF over 30 years.' 
  }
  return {
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-[var(--warm-tan)]/20">
                ...
                <tr className="bg-[var(--warm-white)]/50">
                  ...
                  <td className="px-4 py-3 font-medium text-[var(--charcoal)]">~62 800 €</td>
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 font-medium text-red-600">-5 347 €</td>
                ...
                <tr className="border-t-2 border-[var(--warm-tan)]/40 bg-[var(--sage-pale)]/30">
                  ...
                  <td className="px-4 py-4 font-bold text-[var(--charcoal)]">~66 900 €</td>
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 font-bold text-[var(--forest)]">+35 400 €</td>
        ...
        {/* Section 7: J'ai déjà KBC Pricos — que faire ? */}
        <section>
