...
const BANK_PRODUCTS: Product[] = [
  ...
  // ── Assurance Branche 23 (non-fiscale) ─────────────────────────────────────
  // Data sourced from dedicated review articles (analyse-produits/*).
  // defaultRate = grossBaseline - annualFee (taxConfig.entryFee+premiumTax handled by compute.ts).
  {
    id: 'branche23-ag-fund-plus',
    name: 'data.products.branche23-ag-fund-plus.name',
    category: 'bank',
    subcategory: 'bank-specific',
    provider: 'AG Insurance',
    defaultRate: 0.0630,
    ...
    rateEditable: true,
    color: '#1a5a4a',
    description: 'data.products.branche23-ag-fund-plus.description',
    taxConfig: {
      premiumTax: 0.02,
      entryFee: 0.025,
      annualFee: 0.0170,
  ...
  {
    id: 'branche23-baloise-invest',
    name: 'data.products.branche23-baloise-invest.name',
    category: 'bank',
    subcategory: 'bank-specific',
    provider: 'Baloise',
    defaultRate: 0.0565,
    ...
    rateEditable: true,
    color: '#4a8a5a',
    description: 'data.products.branche23-baloise-invest.description',
    taxConfig: {
      premiumTax: 0.02,
      entryFee: 0.035,
      annualFee: 0.0220,
  ...
  {
    id: 'branche23-nn-strategy',
    name: 'data.products.branche23-nn-strategy.name',
    category: 'bank',
    subcategory: 'bank-specific',
    provider: 'NN Insurance',
    defaultRate: 0.0635,
    grossBaseline: 0.0800,
    ter: 0.0150,
    rateEditable: true,
    color: '#2a4a6a',
    description: 'data.products.branche23-nn-strategy.description',
    taxConfig: {
      premiumTax: 0.02,
      entryFee: 0.01,
      annualFee: 0.0150,
  ...
  {
    id: 'branche23-axa-index4p',
    name: 'data.products.branche23-axa-index4p.name',
    category: 'bank',
    subcategory: 'bank-specific',
    provider: 'AXA',
    defaultRate: 0.0660,
    ...
    rateEditable: true,
    color: '#5a4a7a',
    description: 'data.products.branche23-axa-index4p.description',
    taxConfig: {
      premiumTax: 0.02,
      entryFee: 0.01,
      annualFee: 0.0140,
  ...
  {
    id: 'branche23-vivium-selection',
    name: 'data.products.branche23-vivium-selection.name',
    category: 'bank',
    subcategory: 'bank-specific',
    provider: 'Vivium (P&V)',
    defaultRate: 0.0760,
    grossBaseline: 0.1014,
    ter: 0.0254,
    rateEditable: true,
    color: '#8a5a4a',
    description: 'data.products.branche23-vivium-selection.description',
    taxConfig: {
      premiumTax: 0.02,
      entryFee: 0.0254,
      annualFee: 0.0254,
  ...
  // ── SICAV / FCP (fonds de capitalisation enregistrés en Belgique) ─────────
  {
    id: 'fonds-bnp-comfort-equity',
    name: 'data.products.fonds-bnp-comfort-equity.name',
    category: 'bank',
    subcategory: 'active-fund',
    provider: 'BNP Paribas',
    defaultRate: 0.0544,
    ...
    rateEditable: true,
    color: '#3a5a8a',
    description: 'data.products.fonds-bnp-comfort-equity.description',
    warningNote: "p_fonds_bnp_warning",
    taxConfig: {
      capitalGainsTax: 0.10,
      capitalGainsExemption: 10000,
  ...
  {
    id: 'fonds-carmignac-investissement',
    name: 'data.products.fonds-carmignac-investissement.name',
    category: 'bank',
    subcategory: 'active-fund',
    provider: 'Carmignac',
    defaultRate: 0.0877,
    grossBaseline: 0.1092,
    ter: 0.0215,
    bondAllocation: 0,
    rateEditable: true,
    color: '#5a3a4a',
    description: 'data.products.fonds-carmignac-investissement.description',
    taxConfig: {
      capitalGainsTax: 0.10,
      capitalGainsExemption: 10000,
      entryFee: 0.04,
  ...
  {
    id: 'fonds-crelan-opportunities',
    name: 'data.products.fonds-crelan-opportunities.name',
    category: 'bank',
    subcategory: 'active-fund',
    provider: 'Crelan',
    defaultRate: 0.0257,
    grossBaseline: 0.0537,
    ter: 0.0207,
    bondAllocation: 0,
    rateEditable: true,
    color: '#8a4a4a',
    description: 'data.products.fonds-crelan-opportunities.description',
    taxConfig: {
      capitalGainsTax: 0.10,
      capitalGainsExemption: 10000,
      entryFee: 0.025,
  ...
  // ── Branche 21 supplémentaires (issus des analyses dédiées) ─────────────────
  {
    id: 'branche21-ag-safe-plus',
    name: 'data.products.branche21-ag-safe-plus.name',
    category: 'branche21',
    subcategory: 'bank-specific',
    provider: 'AG Insurance',
    defaultRate: 0.0280,
    rateEditable: true,
    color: '#8a6a2a',
    description: 'data.products.branche21-ag-safe-plus.description',
    taxConfig: {
      premiumTax: 0.02,
      entryFee: 0.01,
      tob: 0,
  ...
  {
    id: 'branche21-belfius-capital-safe',
    name: 'data.products.branche21-belfius-capital-safe.name',
    category: 'branche21',
    subcategory: 'bank-specific',
    provider: 'Belfius Insurance',
    defaultRate: 0.0268,
    rateEditable: true,
    color: '#5a4a6a',
    description: 'data.products.branche21-belfius-capital-safe.description',
    taxConfig: {
      premiumTax: 0.02,
      entryFee: 0.025,
      annualFee: 0.0012,
