...
export const STRATEGIES: Strategy[] = [
  ...
  },
  {
    ...
    complexity: 'simple', horizon: ['long'], esg: true, geographic: ['global', 'emerging'],
    etfs: [
      { ticker: 'XMAW', isin: 'IE00BGHQ0G80', name: 'Xtrackers MSCI AC World Screened UCITS ETF 1C', allocation: 100, ter: 0.25, accumulating: true },
    ],
    historicalReturn: 0.107,
    historicalReturnPeriod: '2016–2025',
